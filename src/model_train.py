...
def train_model(config_file):
    ...
    if(train == True):
        ...
        zoom = config['img_augment']['zoom_range']
        horizontal = config['img_augment']['horizontal_flip']
        vertical = config['img_augment']['vertical_flip']
    ...
    class_mode=class_mode
        ...
        history = mod.fit(
    train_set,
    epochs=epochs,  # This is where 'epochs' should be used
